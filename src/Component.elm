module Component exposing (heading, layout)
...
form : Form.View.FormConfig msg (Element msg) -> Element msg
form { onSubmit, action, loading, state, fields } =
    ...
    column
        ...
        (fields ++ [ formFeedback, submitButton ])
